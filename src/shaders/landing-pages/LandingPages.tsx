...
export function KageLandingPage(props: LandingPageProps & PageTypographyProps) {
  ...
  return <LandingPageFrame {...frame} customization={customization} title="Kage â€” Where stillness reveals the unseen" sourceUrl="/landing-pages/kage.html" />;
}
...
export function CompleteShelfLandingPage(props: LandingPageProps & PageTypographyProps) {
  ...
  return <LandingPageFrame {...frame} customization={customization} title="Working Volumes â€” Seven Tools for Making" sourceUrl="/landing-pages/complete-shelf-v2.html" />;
}
...
export function BestsellersBookShowcase(props: LandingPageProps & PageTypographyProps) {
  ...
  return <LandingPageFrame {...frame} customization={customization} title="Field Manuals â€” Tools for Thought" sourceUrl="/landing-pages/bestsellers-book-showcase.html" />;
}
...
export function InkboundRiverStory(props: LandingPageProps & PageTypographyProps) {
  ...
  return <LandingPageFrame {...frame} customization={customization} title="The River Remembers â€” Inkbound" sourceUrl="/landing-pages/inkbound-river-story.html" />;
}

export function NoctilucaLandingPage(props: LandingPageProps) {
  return <LandingPageFrame {...props} title="Noctiluca â€” The dark is not empty" sourceUrl="/landing-pages/noctiluca.html" />;
}

export function AgentArcanaLandingPage(props: LandingPageProps) {
  return <LandingPageFrame {...props} title="Meng To â€” Agent Arcana" sourceUrl="/landing-pages/agent-arcana.html" />;
}
...
/* The vortex is the packaged page itself, loaded from its own URL. The other
   ...
   `scripts/build-ascii-scenes.mjs`: each carries the authored drawing system â€”
   the layer depth rig, the near/far light ramp, the shading-cloud and grain
   passes, the glyph-sampling pointer dust and its suction well â€” and replaces
...
const ASCII_FIELD_TITLES: Record<AsciiFieldVariant, string> = {
  vortex: "Sable â€” ASCII vortex background",
  tide: "ASCII Tide â€” glyph swell background",
  ridge: "ASCII Ridge â€” glyph range background",
  canopy: "ASCII Canopy â€” glyph tree background",
};
...
export function AsciiPageTransitionHero({ variant = "vortex", presentation = "background", ...props }: AsciiPageTransitionHeroProps) {
  ...
  return (
    <LandingPageFrame
      ...
      title={presentation === "page" && safeVariant === "vortex" ? "Sable â€” Agents should ship, not start over" : ASCII_FIELD_TITLES[safeVariant]}
...
export function TrochilHero(props: LandingPageProps) {
  return <LandingPageFrame {...props} backgroundCanvasSelector="#gl" title="Trochil â€” particle field background" sourceUrl="/landing-pages/trochil-hero.html" />;
}
...
export function AttuneHero(props: LandingPageProps & PageTypographyProps) {
  ...
  return <LandingPageFrame {...frame} customization={customization} title="attune â€” Tuned to every visitor" sourceUrl="/landing-pages/attune-hero.html" />;
}
...
const BETAWISE_GLOBE_TITLES: Record<BetawiseGlobeVariant, string> = {
  betawise: "Betawise â€” network globe background",
  moon: "Moon â€” mare and highland background",
  mars: "Mars â€” albedo and crater background",
  saturn: "Saturn â€” ring system background",
  sun: "Sun â€” granulation and prominence background",
};
 ...
 * rather than a second copy of its numbers â€” and they work identically on the
...
export type BetawiseGlobeSceneProps = {
  ...
  /** CFG.RIM_LIGHT â€” the halo the limb lights on its own. */
  limbGlow?: number;
  /** CFG.EXPOSURE, the tonemap's shoulder. */
  exposure?: number;
  /** CFG.BLOOM, how much of the three-mip chain is summed back. */
  bloom?: number;
  /** CFG.DUST_GAIN â€” the star volume, or the corona on the Sun. */
  starGlow?: number;
  /** CFG.ARC_GAIN â€” Earth's routes, Saturn's rings, the Sun's prominences. */
  arcGlow?: number;
};
...
/**
 * The authored page is served byte-for-byte for the base entry â€” the frame loads it
...
export function KairoLandingPage(props: LandingPageProps & PageTypographyProps) {
  ...
  return <LandingPageFrame {...frame} customization={customization} title="KAIRO â€” Heat With Intent." sourceUrl="/landing-pages/kairo-culinary.html" />;
}
...
export function VoltaAtelierLandingPage(props: LandingPageProps & PageTypographyProps) {
  ...
  return <LandingPageFrame {...frame} customization={customization} title="Volta Atelier â€” Creative Design & 3D Studio" sourceUrl="/landing-pages/volta-atelier.html" />;
}
...
/* The signal tree is the packaged page itself, loaded from its own URL so it
   ...
   system â€” the GPU-extruded ribbons, the dual-filter bloom, the composite and
   its grain â€” and replaces the curve the strands follow, the palette and the
...
const AXONIS_TITLES: Record<AxonisVariant, string> = {
  "signal-tree": "Axonis â€” signal tree background",
  arbor: "Axonis â€” canopy and root background",
  vortex: "Axonis â€” deep field funnel background",
  tide: "Axonis â€” open water background",
  dune: "Axonis â€” sand sea background",
};
...
export function HalfwaveLandingPage(props: LandingPageProps) {
  return <LandingPageFrame {...props} title="Halfwave â€” analogue design studio" sourceUrl="/landing-pages/codescan.html" />;
}
...
export function MiraSolvangLandingPage({ presentation = "background", ...props }: MiraSolvangLandingPageProps) {
  return <LandingPageFrame {...props} backgroundCanvasSelector={presentation === "background" ? "#gl" : undefined} title={presentation === "background" ? "Mira Solvang â€” monitor wall background" : "Mira Solvang â€” Motion Designer"} sourceUrl="/landing-pages/mira-solvang.html" />;
}
...
const TIDECREST_HERO_TITLES: Record<TidecrestHeroVariant, string> = {
  tidecrest: "Tidecrest â€” ridgeline field background",
  "harbour-nights": "Tidecrest â€” harbour nights background",
  "dune-reach": "Tidecrest â€” dune reach background",
  "river-hollow": "Tidecrest â€” river hollow background",
};
...
export function CentraLandingPage(props: LandingPageProps) {
  return <LandingPageFrame {...props} title="Centra â€” Intelligence In The Open" sourceUrl="/landing-pages/centra.html" />;
}
 ...
 * serves its scene alone â€” the marketing layer is gone from the document rather
 * than hidden inside the frame â€” and each variant swaps the body in the sky and
...
/** Every knob `window.__meridian` in ascend.html will accept, as a multiplier
    over what the page was authored with â€” so 1 is the scene, not the middle of
...
const MERIDIAN_TITLES: Record<MeridianVariant, string> = {
  earth: "Meridian â€” orbital Earth background",
  moon: "Meridian â€” orbital Moon background",
  mars: "Meridian â€” orbital Mars background",
  saturn: "Meridian â€” orbital Saturn background",
};
 ...
 * much air stands over it, and the colours the frame is graded through â€”
...
export function MeridianLandingPage({
  ...
  /* Rebuilt whenever a slider moves, which is what re-runs the frame effect.
     ...
     that are not uniforms â€” orbit speed, pointer sway, sun azimuth â€” need no
...
export function MengToSketchbookLandingPage(props: LandingPageProps & PageTypographyProps) {
  ...
  return <LandingPageFrame {...frame} customization={customization} title="Meng To â€” Singapore Sketchbook" sourceUrl="/landing-pages/meng-to-sketchbook.html" />;
}

export function SekiteiLandingPage(props: LandingPageProps) {
  return <LandingPageFrame {...props} title="Sekitei â€” One day in a dry garden" sourceUrl="/landing-pages/sekitei.html" />;
}
...
export function RenderLabLandingPage(props: LandingPageProps & PageTypographyProps) {
  ...
  return <LandingPageFrame {...frame} customization={customization} title="RenderLab â€” Motion House" sourceUrl="/landing-pages/renderlab-motion-house.html" />;
}
...
export function EchoValeLandingPage(props: LandingPageProps & PageTypographyProps) {
  ...
  return <LandingPageFrame {...frame} customization={customization} title="Echo Vale â€” Follow the signal beneath the stone" sourceUrl="/landing-pages/echo-vale.html" />;
}
...
export function AurelloLandingPage(props: LandingPageProps & PageTypographyProps) {
  ...
  return <LandingPageFrame {...frame} customization={customization} title="Aurello â€” Orange Spritz, Ready to Drink" sourceUrl="/landing-pages/aurello-beverage.html" />;
}

export function LampLandingPage(props: LandingPageProps) {
  return <LandingPageFrame {...props} title="Latent â€” We develop film slowly, by hand" sourceUrl="/landing-pages/lamp.html" />;
}
...
export function MaraVossLandingPage(props: LandingPageProps & PageTypographyProps) {
  ...
  return <LandingPageFrame {...frame} customization={customization} title="Mara Voss â€” An Archive of Vanishing Sounds" sourceUrl="/landing-pages/mara-voss.html" />;
}
...
export function Mk78KeyboardLandingPage(props: LandingPageProps & PageTypographyProps) {
  ...
  return <LandingPageFrame {...frame} customization={customization} title="MKÂ·78 â€” Every key. Every detail." sourceUrl="/landing-pages/mk78-keyboard.html" />;
}
...
export function NoemaN1LandingPage(props: LandingPageProps & PageTypographyProps) {
  ...
  return <LandingPageFrame {...frame} customization={customization} title="NOEMA N1 â€” A machine that listens" sourceUrl="/landing-pages/noema-n1.html" />;
}
...
export function AnthraA40LandingPage(props: LandingPageProps & PageTypographyProps) {
  ...
  return <LandingPageFrame {...frame} customization={customization} title="Anthra A-40 â€” The titanium automatic" sourceUrl="/landing-pages/anthra-a40.html" />;
}

export function AstralAtlasLandingPage(props: LandingPageProps) {
  return <LandingPageFrame {...props} title="Astral Atlas â€” Singular Objects in Orbit" sourceUrl="/landing-pages/astral-atlas.html" />;
}

export function MugenLandingPage(props: LandingPageProps) {
  return <LandingPageFrame {...props} title="MUGEN â€” The Gate Remembers" sourceUrl="/landing-pages/mugen.html" />;
}

export function NodalLandingPage(props: LandingPageProps) {
  return <LandingPageFrame {...props} title="NODAL â€” Series A 40mm T1.9" sourceUrl="/landing-pages/nodal.html" />;
}
...
export function OscillaM1LandingPage(props: LandingPageProps) {
  return <LandingPageFrame {...props} title="OSCILLA M-1 â€” Blender-baked synthesiser" sourceUrl="/landing-pages/oscilla-m1.html" />;
}
...
export function HalvorsenLandingPage(props: LandingPageProps & PageTypographyProps) {
  ...
  return <LandingPageFrame {...frame} customization={customization} title="halvorsen â€” Interfaces built to disappear" sourceUrl="/landing-pages/halvorsen.html" />;
}
...
export function UnderstoryLandingPage(props: LandingPageProps) {
  return <LandingPageFrame {...props} title="understory â€” What grows here grows slowly" sourceUrl="/landing-pages/cogniwave.html" />;
}
 ...
 * applied â€” reused from SylvaLivingWorldScene rather than reimplemented here, so the two
 ...
 * the page â€” dusk plum under Sakura, cold slate under Maple â€” so the dock is
...
/* â”€â”€ nav: the authored glass, retoned to the field behind it â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
.dock {
...
/* â”€â”€ the two native controls â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
   ...
   button's size. It cannot go inside them either â€” clip-path makes a backdrop
...
const SYLVA_HERO_TITLES: Record<SylvaHeroVariant, string> = {
  "living-green": "Sylva â€” Into the living world",
  "sakura-sunset": "Sylva â€” Sakura Sunset",
  "maple-autumn": "Sylva â€” Maple Autumn",
  "sequoia-mist": "Sylva â€” Sequoia Mist",
};
